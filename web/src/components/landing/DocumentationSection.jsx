      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-orange-200 shadow-lg">
            ...
            <h3 className="text-xl font-bold text-orange-900 mb-4">Problem-Driven Approach</h3>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-orange-200 shadow-lg">
            ...
            <h3 className="text-xl font-bold text-orange-900 mb-4">Strategic Trade-offs</h3>
            <p className="text-orange-700 leading-relaxed">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-orange-200 shadow-lg">
            ...
            <h3 className="text-xl font-bold text-orange-900 mb-4">Safety & Adaptability</h3>
            <p className="text-orange-700 leading-relaxed">
