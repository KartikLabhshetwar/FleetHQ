...
const MissionMonitoring = () => {
  ...
  const getStatusIcon = (status) => {
    switch (status) {
      ...
      default:
        return <Info className="h-4 w-4 text-orange-800" />;
    }
  };
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-3xl font-bold text-orange-900 mb-2">Mission Monitoring</h1>
          <p className="text-orange-600">Monitor and control your active drone missions</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-1">
          <div className="bg-white shadow-md rounded-2xl border-2 border-orange-200 overflow-hidden">
            ...
            {missions.length === 0 ? (
              ...
              <ul className="divide-y divide-orange-200 max-h-[calc(100vh-280px)] overflow-y-auto">
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-medium text-orange-900 truncate">{mission.name}</p>
                        <p className="text-xs text-orange-500 truncate flex items-center mt-1">
        ...
        <div className="lg:col-span-3">
          {selectedMission ? (
            <div className="bg-white shadow-md rounded-lg border border-orange-200 overflow-hidden">
              <div className="px-6 py-4 bg-yellow-50 border-b border-orange-200 flex justify-between items-center">
                <div className="flex items-center">
              ...
              <div className="p-6">
                ...
                {selectedMission.status === 'in-progress' && (
                  <div className="mb-6">
                    <div className="bg-white border border-orange-200 rounded-lg p-4 mb-4 shadow-inner">
                      ...
                      {dronePosition && (
                        <div className="mt-3 grid grid-cols-3 gap-4 bg-orange-50 p-3 rounded-lg">
                          <div className="flex flex-col">
                            <span className="text-xs text-orange-500 mb-1">Coordinates</span>
                            <span className="text-sm font-medium">
                              {dronePosition.lat.toFixed(6)}, {dronePosition.lng.toFixed(6)}
                            </span>
                          </div>
                          <div className="flex flex-col">
                            <span className="text-xs text-orange-500 mb-1">Altitude</span>
                            <span className="text-sm font-medium">
                              {dronePosition.altitude || selectedMission.flightParameters.altitude}m
                            </span>
                          </div>
                          <div className="flex flex-col">
                            <span className="text-xs text-orange-500 mb-1">Speed</span>
                            <span className="text-sm font-medium">
                ...
                <div className="grid grid-cols-1 md:grid-cols-5 gap-6 mb-6">
                  {/* Mission Details */}
                  <div className="md:col-span-3 bg-white border border-orange-200 rounded-lg p-5 shadow-sm">
                    <h3 className="text-md font-medium text-orange-700 mb-4 pb-2 border-b border-orange-100">Mission Parameters</h3>
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-3">
                        <div>
                          <p className="text-xs font-medium uppercase text-orange-500">Scheduled Time</p>
                          <p className="text-sm font-medium text-orange-800 mt-1">
                            {formatDateTime(selectedMission.schedule.dateTime)}
                          </p>
                        </div>
                        <div>
                          <p className="text-xs font-medium uppercase text-orange-500">Flight Pattern</p>
                          <p className="text-sm font-medium text-orange-800 mt-1 capitalize">
                            {selectedMission.flightParameters.flightPattern}
                          </p>
                        </div>
                        <div>
                          <p className="text-xs font-medium uppercase text-orange-500">Mission Type</p>
                          <p className="text-sm font-medium text-orange-800 mt-1">
                      ...
                      <div className="space-y-3">
                        <div>
                          <p className="text-xs font-medium uppercase text-orange-500">Altitude</p>
                          <p className="text-sm font-medium text-orange-800 mt-1">
                            {selectedMission.flightParameters.altitude}m
                          </p>
                        </div>
                        <div>
                          <p className="text-xs font-medium uppercase text-orange-500">Speed</p>
                          <p className="text-sm font-medium text-orange-800 mt-1">
                            {selectedMission.flightParameters.speed} m/s
                          </p>
                        </div>
                        <div>
                          <p className="text-xs font-medium uppercase text-orange-500">Image Overlap</p>
                          <p className="text-sm font-medium text-orange-800 mt-1">
                  ...
                  {/* Mission Controls */}
                  <div className="md:col-span-2 bg-white border border-orange-200 rounded-lg p-5 shadow-sm">
                    <h3 className="text-md font-medium text-orange-700 mb-4 pb-2 border-b border-orange-100">Mission Controls</h3>
                    <div className="space-y-3">
                      ...
                      {canEditMission(selectedMission.status) && (
                        <Link
                          ...
                          className="w-full inline-flex justify-center items-center px-4 py-2 border border-orange-300 text-sm font-medium rounded-md shadow-sm text-orange-700 bg-white hover:bg-orange-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors duration-150"
                        >
                          Edit Mission
                        </Link>
                      )}
                ...
                <div className="bg-white border border-orange-200 rounded-lg p-5 shadow-sm">
                  <h3 className="text-md font-medium text-orange-700 mb-3 pb-2 border-b border-orange-100 flex items-center">
            ...
            <div className="bg-white shadow-md rounded-lg border border-orange-200 overflow-hidden h-full flex items-center justify-center">
              <div className="p-8 text-center max-w-md">
                ...
                <h3 className="mt-4 text-lg font-medium text-orange-900">No mission selected</h3>
                ...
                <div className="mt-6">
                  <Link
                    to="/missions/new"
                    className="inline-flex items-center px-4 py-2 border-3 border-orange-300 rounded-lg hover:bg-orange-200"
                  >
                    Create New Mission
                  </Link>
                </div>
